                ...
                <form class="form-container" method="POST">
                    <div class="row">
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control" placeholder="UserName" name="username" aria-describedby="btninputemail">
                        </div>
                        <div class="input-group">
                            <div class="input-group-text" id="btninputpass" style="background-color:#f8e7e0 ; width:50px;"><i class="fas fa-lock"></i></div>
                            <input type="password" class="form-control" placeholder="Password" name="password" aria-describedby="btninputpass">
                        </div>
                        ...
                        <div class="col-12 text-right">
                            <span style="font-size:18px;">If don't have acccount <a href="signUp.php" style="color:#f8e7e0 ;">Register Here</a></span>
                        </div>
                    </div>
                </form>
            </div>
