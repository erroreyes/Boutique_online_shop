    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="crud.php" method="POST" enctype="multipart/form-data">
                    <div class="bg-light">
                        <p class="text-dark  text-center p-5" style="font-size:27px;">Are you sure to delete id =<input type="text" id="user_deleteid" name="user_deleteid" class="border-0 text-center bg-light text-dark" style="width:5%;font-size:27px;"> ?</p>
                    </div>
